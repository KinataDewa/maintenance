...
@section('title', 'Riwayat Pengecekan AC')

@section('content')
<div class="container py-4">
    <h1 class="page-title mb-4">Riwayat Pengecekan AC</h1>

    @if($pengecekanAcs->isEmpty())
        <div class="alert alert-info">Belum ada data pengecekan AC.</div>
    @else
        @php
            // Grouping berdasarkan tanggal
            $grouped = $pengecekanAcs->groupBy(function($item) {
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-dark text-white">
                                                            <h5 class="modal-title">Detail Pengecekan AC - {{ $data->ac->nama ?? '-' }}</h5>
