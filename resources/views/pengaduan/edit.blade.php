...
<div class="container py-4" style="max-width: 700px;">
    <h3 class="page-title mb-4 fw-bold">Edit Pengaduan #{{ $pengaduan->id }}</h3>
    ...
    <form action="{{ route('pengaduan.update', $pengaduan->id) }}" method="POST" class="card p-4 shadow-sm rounded-4">
        ...
        {{-- Progres --}}
        <div class="mb-3">
            <label class="form-label fw-semibold">Progres / Catatan</label>
            <textarea name="progres" class="form-control" rows="3" placeholder="Tuliskan progres atau catatan pengerjaan">{{ old('progres', $pengaduan->progres) }}</textarea>
        </div>
